...
def fetch_data(provincecode: str, policestationcode: str, year: int, quarter: int):
       
    endpoint = f"{config.BaseUrl_fethcrimestats}provincecode={provincecode}&policestation={policestationcode}&year={year}&quarter={quarter}"
